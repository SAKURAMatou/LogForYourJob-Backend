...
async def add_interview_question(questionAddParam: QuestionAddParam, user: UserSession = Depends(get_user_session),
    ...
    try:
        ...
        interviewQuestion.tag_name = questionAddParam.tagName
        interviewQuestion.tag_value = questionAddParam.tagValue
...
@router.post("/question/updateViewTimes")
...
@router.get("/question/detail/{questionguid}")
